...
@interface TXModelTransition ()

@property (nonatomic, assign) TXTransitionType type;
...
@implementation TXModelTransition
...
+ (TXModelTransition *)transitionWithType:(TXTransitionType)type
                             ...
                             presentHeight:(CGFloat)presentHeight
                                     scale:(CGPoint)scale {
    TXModelTransition *transition = [[TXModelTransition alloc] init];
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    switch (self.type) {
        case kTXModelTransitionPresent: {
            [self present:transitionContext];
            break;
        }
        case kTXmodelTransitionDiss: {
